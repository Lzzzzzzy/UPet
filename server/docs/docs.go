    ...
    "paths": {
        "/api/auth": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "微信签发的code",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.AuthInfo"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.PetTodoInfo"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.PetTodoInfoResponse"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/petTodo.PetTodoInfo"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "更新宠物待办信息",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/petTodo.SimplePetTodoInfo"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/response.PetInfoResponse"
                                            }
                                        },
                                        "msg": {
                                            "type": "string"
    ...
    "definitions": {
        ...
        "config.Server": {
            ...
            "properties": {
                ...
                "email": {
                    "$ref": "#/definitions/github_com_Lzzzzzzy_UPet_server_config.Email"
                },
                "excel": {
        ...
        "config.Wechat": {
            ...
            "properties": {
                "miniprogram": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/config.WechatMiniprogram"
                        }
                    ]
                }
            }
        ...
        "github_com_Lzzzzzzy_UPet_server_config.Email": {
            "type": "object",
            "properties": {
                "from": {
        ...
        "petTodo.PetTodoInfo": {
            ...
            "properties": {
                ...
                "remindTime": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/common.CustomTime"
                        }
                    ]
                },
                "title": {
                ...
                "type": {
                    "description": "提醒类型， 0：日常记录， 1：待办事项",
                    "type": "integer"
                },
                "updatedAt": {
                    "description": "更新时间",
